...
function FeedbackForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto p-6 bg-white shadow-md rounded-md space-y-6">
      <div>
        <label htmlFor="name" className="block text-sm font-monoton text-gray-900">Name</label>
        <input
          id="name"
          type="text"
          name="name"
      ...
      <div>
        <label htmlFor="email" className="block text-sm font-monoton text-gray-700">Email Address</label>
        <input
          id="email"
          type="email"
          name="email"
